  ...
  def parse(data: DataInputStream, size: Int): RecvPacket = {
    ...
    subCommand match {
      ...
      case 0x19 =>
        ...
        val strength: StatLock.Type = StatLock.apply(flags & 0x03)
        val dexterity: StatLock.Type = StatLock.apply(flags & 0x12)
        val intelligence: StatLock.Type = StatLock.apply(flags & 0x48)
