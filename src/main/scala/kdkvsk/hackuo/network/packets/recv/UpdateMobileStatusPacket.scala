...
case class UpdateMobileStatusPacket(serial: Serial,
                                    maxHits: Short, hits: Short,
                                    maxMana: Short, mana: Short,
                                    maxStamina: Short, stamina: Short) extends RecvPacket

object UpdateMobileStatusPacketParser extends RecvPacketParser {
  ...
  def parse(data: DataInputStream, size: Int): RecvPacket = {
    ...
    UpdateMobileStatusPacket(serial, maxHits, hits, maxMana, mana, maxStamina, stamina)
  }
}
