...
case class x23_DragAnimationPacket(modelId: Short, amount: Short,
...
object x23_DragAnimationPacketParser extends RecvPacketParser {
  ...
  def parse(data: DataInputStream, size: Int): RecvPacket = {
    ...
    x23_DragAnimationPacket(modelId, amount, sourceSerial, sourceX, sourceY, sourceZ, targetSerial, targetX, targetY, targetZ)
  }
}
