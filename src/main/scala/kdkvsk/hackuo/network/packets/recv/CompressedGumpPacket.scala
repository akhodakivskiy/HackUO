...
case class CompressedGumpPacket(serial: Int, gumpId: Int, x: Int, y: Int, data: String, texts: Seq[String]) extends RecvPacket {
  val id: Int = CompressedGumpPacketParser.packetId

  def gump: Gump = CompressedGumpPacketParser.assembleGump(this)
}

object CompressedGumpPacketParser extends RecvPacketParser {
  ...
  def assembleGump(packet: CompressedGumpPacket): Gump = {
