...
case class xC0_GraphicalEffectPacket(effectType: Byte, sourceSerial: Serial, targetSerial: Serial, graphicId: GraphicId, x: Short, y: Short, z: Byte,
                                     speed: Byte, duration: Byte, explodes: Byte, hue: Int, renderMode: Int) extends RecvPacket

object xC0_GraphicalEffectPacketParser extends RecvPacketParser {
  ...
  def parse(data: DataInputStream, size: Int): RecvPacket = {
    ...
    xC0_GraphicalEffectPacket(effectType, sourceSerial, targetSerial, graphicId, x, y, z, speed, duration, explodes, hue, renderMode)
  }
}
