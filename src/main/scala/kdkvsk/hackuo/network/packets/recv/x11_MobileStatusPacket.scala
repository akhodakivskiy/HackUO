...
case class x11_MobileStatusPacket(serial: Serial, name: String, hits: Short, maxHits: Short, nameChangeFlag: Byte,
  ...
  def id: Int = x11_MobileStatusPacketParser.packetId
...
object x11_MobileStatusPacketParser extends RecvPacketParser {
  ...
  def parse(data: DataInputStream, size: Int): RecvPacket = {
    ...
    */
    ...
    val result: x11_MobileStatusPacket = x11_MobileStatusPacket(
      serial = serial,
      name = name,
      hits = hits,
      maxHits = maxHits,
