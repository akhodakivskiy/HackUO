...
case class x3C_AddContainerItemsPacket(items: Seq[AddContainerItem]) extends RecvPacket

object x3C_AddContainerItemsPacketParser extends RecvPacketParser {
  ...
  def parse(data: DataInputStream, size: Int): RecvPacket = {
    ...
    x3C_AddContainerItemsPacket(items)
  }
}
